...
plt.plot(x_data, single_sigmoid_additive(x_data, *popt), label=f"Fitted Model ($R^2={r_squared:.4f}$)", color='red', linewidth=2)
...
png_filename = f"{base_name}_fitted_curve_single_auto.png"
